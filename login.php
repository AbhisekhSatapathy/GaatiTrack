      ...
      <div class="row"style="align-items: center;">
        <div class="col-md-5">
          <div class="login-aside text-center  d-flex flex-column flex-row-auto">
            ...
            <p>"Where precision meets speed, turning every delivery into a promise kept."<br> - GaatiTrack</p>
...
<div class="form-group mb-3">
  ...
  <div>
    <input type="email" class="form-control" value="" name="email" required placeholder="Emai Id">
