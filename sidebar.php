    ...
    <div class="dropdown">
   	<a href="./" class="brand-link">
        <?php if($_SESSION['login_type'] == 1): ?>
          <img src="assets/uploads/logo1.png" width="170px">
    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-4">
        ...
        <?php endif; ?>
         ...
         <li class="nav-item dropdown">
            <a href="./index.php?page=new_parcel" class="nav-link nav-reports">
           ...
           <li class="nav-item dropdown">
            <a href="./index.php?page=parcel_list" class="nav-link nav-reports">
...
<li class="nav-item">
  <a href="https://www.linkedin.com/in/abhisekh-satapathy-995008280" class="nav-link" target="_blank">
    <img src="https://kissandharambir.com/wp-content/uploads/2022/08/contact.gif" alt="XYZ Logo" style="max-width: 100%; height: auto;">
  </a>
</li>
