	...
	<div class="card card-outline">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-primary" href="./index.php?page=new_staff">Add</a>
			</div>
		</div>
		<div class="card-body">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
		                    <div class="btn-group">
		                        <a href="index.php?page=edit_staff&id=<?php echo $row['id'] ?>"  class="edit">
		                          <i class="fas fa-edit"></i>
		                        </a>
		                        <a href="index.php?page=staff_list&delete_id=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure to delete this staff?')">
